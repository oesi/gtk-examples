...
/**
 * Calculate position of actor 1 and len/angle to actor 2
 */
...
void drawLine(ClutterActor *parent, ClutterActor *actor1, ClutterActor *actor2)
{
	...
	ClutterColor myLineColor = { 0, 0, 0, 255 };
...
static void activate (GtkApplication *app, gpointer user_data)
{
  ...
  gtk_window_set_title (GTK_WINDOW (window), "Clutter Example With GTK+");
...
int main(int argc, char *argv[])
{
	...
	app = gtk_application_new ("oesi.org.example.clutter.gtk", G_APPLICATION_FLAGS_NONE);
